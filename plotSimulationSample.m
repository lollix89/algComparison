...
function plotSimulationSample(nRobots, folder)
close all
...
for i=1:nRobots
    tmpY= shortRangePlotY(1:10:end,i);
    tmpSTD= shortRangeSTD(1:10:end,i);
    errorbar(plotRangeX(1:10:end), tmpY, tmpSTD, '.k')
end
...
%adding error bars for STD
for i=1:nRobots
    tmpY= mediumRangePLotY(1:10:end,i);
    tmpSTD= mediumRangeSTD(1:10:end,i);
    errorbar(plotRangeX(1:10:end,i), tmpY, tmpSTD, '.k')
end
...
%adding error bars for STD
for i=1:nRobots
    tmpY= longRangePlotY(1:10:end,i);
    tmpSTD= longRangeSTD(1:10:end,i);
    errorbar(plotRangeX(1:10:end,i), tmpY, tmpSTD, '.k')
end
