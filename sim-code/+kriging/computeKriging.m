function [interpValues,krigError]=computeKriging(X,Y,stdV,meanV,fittedModel,fittedParam,x,y)
...
trendOrder= 0;
krigMat= kriging.generateKrigMatrix(X, fittedModel, fittedParam, trendOrder);

[interpValuesNorm, krigError]= kriging.UniversalKriging(krigMat,X,Y, fittedModel, fittedParam, x,y, trendOrder);
